...
are complete. Native Testing Foundation Slices 1 and 2 are complete, Slice 3 is
next, and Stage 34 waits for the foundation. The native port remains after Stage 44 so
