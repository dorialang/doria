...
function-type authority. Stages 30a through 30f are complete: valid closures
...
compatibility backend execute the supported surface. Stage 30g is next and Stage
30 remains incomplete.
