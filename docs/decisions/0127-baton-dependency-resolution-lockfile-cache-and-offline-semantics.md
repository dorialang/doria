...
Stage 34 is complete and Stage 35 Slices 1, 2, and 3 are complete and Slice 4 is next.
...
- `docs/doria-end-to-end-plan.md` and `docs/notes/current-pipeline.md`: Stage 33
  ...
  complete; Stage 35 Slices 1, 2, and 3 are complete and Slice 4 is next.
