...
Stage 34 is complete and Stage 35 Slices 1, 2, 3, and 4 are complete and Slice 5 is next.
...
- `docs/doria-end-to-end-plan.md` and `docs/notes/current-pipeline.md`: Stage 33
  ...
  complete; Stage 35 Slices 1, 2, 3, and 4 are complete and Slice 5 is next.
