...
- `README.md`, `SPEC.md`, `docs/doria-end-to-end-plan.md`, and
  ...
  complete. Decision 0129 implements the Native Testing Foundation; Slices 1
  through 3 and the foundation are complete, and Stage 34 is complete and Stage 35 Slices 1, 2, 3, and 4 are complete and Slice 5 is next.
