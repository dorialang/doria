...
- **Interactive Line-Input Amendment — Implemented.** Amends decision 0074's
  ...
  is complete, and decision 0110 accepts the stream architecture and performance contract. Stage 26, Stage 26a, and Stage 26b are complete; the performance `Measurement Status: Pending Available Runner` is non-blocking, Decision 0113 Slices 1-2 are complete, Slice 3 is next, Slice 4 is pending, and Stage 27 is sequenced after Decision 0113 with no performance-evidence dependency.

  **Current planning checkpoint:** Stage 25a — Complete; PHP Stream And I/O Completeness Audit — Implemented; Andrew’s Stream API Completeness Review — Complete; Stream Architecture And Performance Decision — Accepted (decision 0110); Stage 26 — Complete; Stage 26a — Complete; Stage 26b — Complete, All Three Slices Complete (decision 0112); Measurement Status: Pending Available Runner; Decision 0113 Slice 1 — Complete; Decision 0113 Slice 2 — Complete; Decision 0113 Slice 3 — Next; Decision 0113 Slice 4 — Pending; Stage 27 — Sequenced After Decision 0113, No Performance-Evidence Dependency; Stage 35a — Scheduled; Stage 36a — Scheduled; Stage 36a Public Spellings — Deferred; Stage 36a — Not Implemented.
...
- **Decision 0113 — Collection Surface Completion — Slices 1-2 Complete.** Slice 2 adds one compiler-owned receiver-aware suggestion table, structured E0521 fixes, a dedicated property-invoked-as-method diagnostic, operation-specific equality diagnostics, bracket-literal guidance for withdrawn `List::from` / `Dictionary::from`, and accepted-pending diagnostics that stop before MIR. Slice 3 is next; Slice 4 remains pending. Performance impact: no generated runtime, representation, ABI, allocation, copy, dispatch, or backend-lowering change; only a bounded lookup after failed collection-member resolution.
