...
| `Doria\Std\Test` collection/Error expectation members | Slice 3 implements collection/dictionary matchers, `toThrow`, typed Error inspectors, bounded differences, Baton classification/hierarchy, and compiler-fact-based tooling | The earlier Slice-3 implementation boundary is retired | Complete | Decision 0129 | Native Testing Foundation Slices 1 Through 3 | No live stage boundary remains; E0710 is historical and reserved |
