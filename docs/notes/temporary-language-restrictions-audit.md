...
| E0641 closure execution boundary | Semantically valid closure values stop before executable lowering | Closure acquisition, lifetime, MIR, and backend slices are staged | Accepted But Not Implemented | Decision 0121 | Stage 30c and later closure slices | Yes as `UnsupportedDevelopmentSurface`, not invalid Doria |
