...
| E0641 closure execution boundary | Ownership-valid closure values stop before executable lowering | Closure HIR/MIR, interpreter, and backend execution slices are staged | Accepted But Not Implemented | Decision 0121 | Stage 30d and later closure slices | Yes as `UnsupportedDevelopmentSurface`, not invalid Doria |
