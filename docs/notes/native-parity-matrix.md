...
| `mixed` static boundary | Frontend | Frontend | Frontend | Covered | Bare operations are rejected until exact `is` narrowing; live runtime values stop before MIR with the Stage 23 Slice 3 diagnostic. |
