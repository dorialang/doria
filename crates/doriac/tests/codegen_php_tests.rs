...
#[test]
fn debug_backend_emits_stage_11c_artifact_and_rejects_broader_source() {
...
"#,
    ...
    .expect("debug backend should emit the Stage 11c artifact");
...
"#,
    ...
    .expect_err("broader source should remain outside Stage 11c MIR coverage");
