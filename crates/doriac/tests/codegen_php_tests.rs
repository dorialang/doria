...
#[test]
fn debug_backend_emits_stage_11b_artifact_and_rejects_broader_source() {
...
"#,
    ...
    .expect("debug backend should emit the Stage 11b artifact");
...
"#,
    ...
    .expect_err("broader source should remain outside Stage 11b MIR coverage");
