...
pub const STRING_TRIM: &str = "dr_v1_string_trim";
pub const STRING_TRIM_START: &str = "dr_v1_string_trim_start";
pub const STRING_TRIM_END: &str = "dr_v1_string_trim_end";
pub const STRING_LOWER: &str = "dr_v1_string_lower";
pub const STRING_UPPER: &str = "dr_v1_string_upper";
pub const STRING_LOWER_FIRST: &str = "dr_v1_string_lower_first";
pub const STRING_UPPER_FIRST: &str = "dr_v1_string_upper_first";
...
pub const STRING_CONTAINS_IGNORE_CASE: &str = "dr_v1_string_contains_ignore_case";
pub const STRING_STARTS_WITH_IGNORE_CASE: &str = "dr_v1_string_starts_with_ignore_case";
pub const STRING_ENDS_WITH_IGNORE_CASE: &str = "dr_v1_string_ends_with_ignore_case";
pub const STRING_EQUALS_IGNORE_CASE: &str = "dr_v1_string_equals_ignore_case";
pub const STRING_INDEX_OF: &str = "dr_v1_string_index_of";
pub const STRING_LAST_INDEX_OF: &str = "dr_v1_string_last_index_of";
pub const STRING_INDEX_OF_IGNORE_CASE: &str = "dr_v1_string_index_of_ignore_case";
pub const STRING_LAST_INDEX_OF_IGNORE_CASE: &str = "dr_v1_string_last_index_of_ignore_case";
pub const STRING_COUNT_OCCURRENCES: &str = "dr_v1_string_count_occurrences";
pub const STRING_REPLACE: &str = "dr_v1_string_replace";
pub const STRING_SPLIT: &str = "dr_v1_string_split";
pub const STRING_JOIN: &str = "dr_v1_string_join";
pub const STRING_SLICE: &str = "dr_v1_string_slice";
pub const STRING_REPEAT: &str = "dr_v1_string_repeat";
pub const STRING_PAD_START: &str = "dr_v1_string_pad_start";
pub const STRING_PAD_END: &str = "dr_v1_string_pad_end";
