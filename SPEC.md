...
The four Stage 23 intrinsic names are reserved against user declarations now, but calls remain
unsupported until Stage 23 implements their complete contracts.
