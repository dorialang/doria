...
function check_performance_foundation(string $root): array
{
    $requirements = [
        'docs/decisions/0112-performance-baseline-provenance-and-regression-measurement.md' => [
            ...
            'both Stage 31 slices, and Stage 32 are complete',
            'Stage 33 Slices 1 and 2 are complete and Slice 3 is next',
            ...
            'list_map_readonly',
            'list_map_writable',
            'list_map_move_result',
            'list_filter_copy',
            'list_reduce_copy_accumulator',
            'list_reduce_move_accumulator',
            'list_map_checked',
            'list_reduce_checked',
        ],
