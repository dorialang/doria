...
- Keep broader native expression and control-flow support beyond the Stage 4b smoke subset as separate future implementation slices.
...
- Expand native source support beyond Stage 4b only after the next accepted native slice specifies the language semantics and expected behavior.
