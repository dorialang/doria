...
- Keep broader native expression, assignment, and control-flow support beyond the Stage 9 smoke subset as separate future implementation slices.
...
- Expand native source support beyond Stage 9 only after the next accepted native slice specifies the language semantics and expected behavior.
